...
export default function EForum() {
  ...
  const initialPosts = [
    {
      ...
      content: "Welcome to our new E-Forum! We're excited to introduce this enhanced platform for better team communication and collaboration. Share your thoughts, ideas, and feedback here.",
      hearts: 15,
      comments: 15,
      shares: 15,
      views: 245,
    ...
    },
    {
      ...
      content: "Just finished implementing the new user authentication system. The security improvements and user experience enhancements are significant. Looking forward to your feedback!",
      hearts: 22,
      comments: 8,
      shares: 12,
      views: 189,
    ...
    },
    {
      ...
      content: "Our latest design sprint was incredibly productive! We've made great progress on the user interface improvements and accessibility features. Can't wait to show you all what we've created.",
      hearts: 31,
      comments: 18,
      shares: 9,
      views: 342,
    ...
    },
    {
      ...
      content: "Monthly team sync went great today! We discussed upcoming projects, resource allocation, and timeline adjustments. Everyone is aligned and motivated for the coming weeks.",
      hearts: 11,
      comments: 6,
      shares: 7,
      views: 156,
    ...
    },
    {
      ...
      content: "Our latest campaign performance exceeded expectations! The engagement rates are up 40% and we're seeing great conversion numbers. Team effort really paid off.",
      hearts: 28,
      comments: 12,
      shares: 18,
      views: 298,
    ...
    },
    {
      ...
      content: "Closed three major deals this week! The new sales process is working well and client feedback has been overwhelmingly positive. Great momentum going into next quarter.",
      hearts: 35,
      comments: 22,
      shares: 14,
      views: 445,
    ...
    },
    {
      ...
      content: "Q3 financial report is looking strong! We're ahead of budget in several key areas and the cost optimization initiatives are showing great results.",
      hearts: 19,
      comments: 9,
      shares: 11,
      views: 203,
    ...
    },
    {
      ...
      content: "User research insights from last week are fascinating! We've identified several opportunities for improvement and new feature development. Exciting times ahead!",
      hearts: 24,
      comments: 16,
      shares: 8,
      views: 312,
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (container.scrollTop + container.clientHeight >= container.scrollHeight - 200 && !loading) {
        loadMorePosts();
      }
    ...
    <Card className="bg-white/80 backdrop-blur-sm border border-gray-100 hover:shadow-lg hover:scale-[1.01] transition-all duration-300 mb-4">
      <CardContent className="p-5">
        <div className="flex items-start space-x-4">
          <div className={`w-12 h-12 ${getAvatarColor(post.author)} rounded-full flex items-center justify-center flex-shrink-0 shadow-sm`}>
