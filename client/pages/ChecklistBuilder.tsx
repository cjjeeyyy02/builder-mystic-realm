  ...
  const [checklists, setChecklists] = useState<Checklist[]>([
    {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Provide your highest educational qualification",
          type: "File Upload",
          completed: false,
          required: true,
        },
        {
          ...
          description: "Complete work history form",
          type: "Free Text",
          completed: false,
          required: true,
        },
        {
          ...
          description: "Health clearance from physician",
          type: "File Upload",
          completed: false,
          required: true,
        },
      ...
      items: [
        {
          ...
          description: "Submit your design portfolio for review",
          type: "File Upload",
          completed: false,
          required: true,
        },
        {
          id: "2",
          name: "Design Tools Setup",
          description: "Confirm access to design software",
          type: "Checkbox",
          completed: false,
          required: false,
        },
        {
          ...
          description: "Review and acknowledge brand standards",
          type: "Checkbox",
          completed: false,
          required: true,
        },
        {
          id: "4",
          name: "First Design Task",
          description: "Complete assigned starter project",
          type: "Free Text",
          completed: false,
          required: false,
        },
      ...
      items: [
        {
          ...
          description: "Complete all mandatory HR forms and documentation",
          type: "File Upload",
          completed: false,
          required: true,
        },
        {
          ...
          description: "Set up email, SSO, and required tools access",
          type: "Checkbox",
          completed: false,
          required: true,
        },
        {
          ...
          description:
            "Allocate and record company equipment (laptop, peripherals)",
          type: "Checkbox",
          completed: false,
          required: true,
        },
        ...
        },
        {
          ...
          description: "Meet the team and key stakeholders",
          type: "Checkbox",
          completed: false,
          required: false,
        },
        {
          ...
          description: "Review company policies and acknowledge receipt",
          type: "Checkbox",
          completed: false,
          required: true,
        },
  ...
  const handleCreateChecklist = () => {
    if (newChecklist.title.trim()) {
      const checklist: Checklist = {
        ...
        linkedJobs: newChecklist.jobConnected
          ? [newChecklist.jobConnected]
          : [],
        items: [],
      };
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3 text-xs text-gray-500">
                          ...
                          <span className="flex items-center gap-1">
                            ...
                            {checklist.isGeneric
                              ? checklist.label || "Generic for all employees"
          ...
          <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  {selectedChecklist
                    ? `Editing: ${selectedChecklist.title}`
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  setNewChecklist({ ...newChecklist, jobConnected: value })
                }
              >
    ...
    <div className="flex items-center justify-center h-full">
      <div className="text-center max-w-md">
        ...
        <p className="text-gray-600 mb-6">
          Select a checklist from the left panel to edit it, or create a new one
          to get started.
        </p>
        <Button
