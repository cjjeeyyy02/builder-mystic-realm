...
export default function Activities() {
  ...
  const allActivities = [
    {
      ...
      description: "Complete onboarding process including documentation review and workspace setup",
    ...
    },
    {
      ...
      description: "Successfully completed technical assessment with score of 89%. Proceeding to next interview round.",
      department: "HR Department",
    ...
    },
    {
      ...
      description: "All 45 engineering team members have completed their quarterly performance reviews",
    ...
    },
    {
      ...
      description: "All salary payments, bonuses, and deductions have been processed and transferred",
      department: "Finance",
    ...
    },
    {
      ...
      description: "Mandatory cybersecurity training for all employees scheduled for next week",
    ...
    },
    {
      ...
      description: "Lisa Thompson has been promoted to Senior Marketing Manager effective immediately",
    ...
    },
    {
      ...
      description: "Last round interview with CTO scheduled for candidate Maria Rodriguez",
      department: "Engineering",
    ...
    },
    {
      ...
      description: "Updated remote work guidelines now in effect across all departments",
      department: "HR Department",
    ...
    },
    {
      ...
      description: "Applications now open for Q3 leadership development program",
      department: "HR Department",
      timestamp: "1 week ago",
      status: "active",
      priority: "low",
    ...
    },
    {
      ...
      description: "Scheduled maintenance on HR management system completed successfully",
  ...
  const filters = [
    ...
    { id: "active", label: "Active", count: allActivities.filter(a => a.status === "active").length },
    { id: "completed", label: "Completed", count: allActivities.filter(a => a.status === "completed").length },
    { id: "pending", label: "Pending", count: allActivities.filter(a => a.status === "pending").length }
  ];
          ...
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 mt-2 text-lg">Comprehensive view of all company activities and updates</p>
              </div>
              <div className="flex items-center gap-4">
                <Button 
                  className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
                >
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid gap-6">
              {filteredActivities.map((activity) => (
                <Card key={activity.id} className="backdrop-blur-sm bg-white/90 border border-gray-200/50 hover:shadow-lg hover:border-indigo-200/50 transition-all duration-300 group">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      <div className={`w-14 h-14 bg-gradient-to-br from-${activity.color}-500 to-${activity.color}-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                        <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={getIconSvg(activity.icon)} />
                        </svg>
                      </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-6 text-sm text-gray-500">
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium text-indigo-600">{activity.department}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
