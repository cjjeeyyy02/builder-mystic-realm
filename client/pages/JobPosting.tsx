...
const initialJobs: Job[] = [
  {
    ...
    description: "We are looking for a skilled Software Engineer to join our growing engineering team. You will be responsible for developing and maintaining backend services and APIs that power our AI-driven platform.",
    ...
    qualifications: "Bachelor's degree in Computer Science or equivalent experience. 3+ years of backend development experience with Node.js, Python, or Java.",
    perksAndBenefits: "Health insurance, dental coverage, flexible working hours, remote work options, professional development budget.",
  },
  {
    id: "J-1002",
    ...
    description: "Join our design team to create intuitive and engaging user experiences for our AI-powered products. You'll work closely with product managers and engineers to bring innovative designs to life.",
    employmentType: "full-time",
    department: "Design",
    seniorityLevel: "mid-level",
    ...
    applicants: 8,
    integrations: [],
    qualifications: "Bachelor's degree in Design, HCI, or related field. 3+ years of product design experience with proficiency in Figma, Sketch, or Adobe Creative Suite.",
    perksAndBenefits: "Comprehensive health benefits, unlimited PTO, home office stipend, design conference budget.",
  },
  {
    id: "J-1003",
    ...
    description: "We're seeking a DevOps Engineer to help scale our infrastructure and improve our deployment processes. You'll work with cutting-edge cloud technologies and help build reliable, scalable systems.",
    employmentType: "full-time",
    ...
    qualifications: "Bachelor's degree in Computer Science or equivalent. 5+ years of DevOps experience with AWS, Docker, Kubernetes, and CI/CD pipelines.",
    perksAndBenefits: "Competitive salary, pension plan, 25 days annual leave, flexible hybrid working, health insurance.",
  },
];
