...
export default function JobPosting() {
  ...
  const handleSaveManage = () => {
    ...
    const updated: Job = {
      ...
      company: manageForm.company,
      location: manageForm.location,
      workplaceType: manageForm.workplaceType,
      description: manageForm.description,
      employmentType: manageForm.employmentType,
      department: manageForm.department || undefined,
      seniorityLevel: manageForm.seniorityLevel,
      qualifications: manageForm.qualifications || undefined,
      salary: manageForm.salary || undefined,
      applicationMethods: manageForm.applicationMethods || undefined,
      closingDate: manageForm.closingDate || undefined,
      perksAndBenefits: manageForm.perksAndBenefits || undefined,
      screeningQuestions: manageForm.screeningQuestions?.filter(Boolean) || undefined,
