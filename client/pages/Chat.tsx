...
export default function Chat() {
  ...
  const chatList = [
    {
      ...
      lastMessage:
        "Hi, Did you finish the Hi-Fi Wireframes for floor app design?",
      time: "4:20 PM",
      avatar: "JM",
      status: "online",
      unread: 2,
  ...
  const individualMessages = [
    {
      ...
      type: "received",
      content:
        "Hi! Did you finish the Hi-Fi Wireframes for the floor app design?",
      time: "4:20 PM",
      avatar: "JM",
    },
    {
    ...
    },
    {
      ...
      type: "received",
      content:
        "Great! Let's schedule a meeting tomorrow to finalize everything.",
      time: "4:25 PM",
      avatar: "JM",
    },
  ];
  ...
  const groupMessages = [
    ...
    },
    {
      ...
      type: "sent",
      content:
        "Perfect! I've also updated the design mockups based on last week's feedback.",
      time: "9:17 AM",
    },
    {
      id: 4,
  ...
  const currentMessages =
    chatType === "group" ? groupMessages : individualMessages;
            ...
            <div className="w-64 bg-white/70 backdrop-blur-sm border-r border-gray-200/50 flex flex-col">
              ...
              <div className="p-2 border-b border-gray-200/50">
                <div className="relative mb-2">
                  ...
                  />
                  <svg
                    className="w-3 h-3 text-gray-400 absolute left-3 top-1/2 transform -translate-y-1/2"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                      ...
                      >
                        <div className="flex items-start space-x-2">
                          <div className="relative">
                            <div
                              className={`w-8 h-8 ${getAvatarColor(chat.name)} rounded-full flex items-center justify-center shadow-sm`}
                            >
                            ...
                            <div
                              className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 ${getStatusColor(chat.status)} rounded-full border border-white`}
                            ></div>
                          </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <div className="relative">
                        ...
                        {chatType === "individual" && (
                          <div
                            className={`absolute -bottom-0.5 -right-0.5 w-3 h-3 ${getStatusColor(currentChatData.status)} rounded-full border border-white`}
                          ></div>
                        )}
                      </div>
                      <div>
              ...
              <div className="flex-1 overflow-y-auto p-2 space-y-2">
                {rightPanelVisible &&
                  currentMessages.map((msg) => (
                    ...
                    >
                      <div
                        className={`flex items-end space-x-1 max-w-xs lg:max-w-md ${msg.type === "sent" ? "flex-row-reverse space-x-reverse" : ""}`}
                      >
                        {msg.type === "received" && (
                          <div
                            className={`w-6 h-6 ${getAvatarColor(msg.senderName || "user")} rounded-full flex items-center justify-center flex-shrink-0 shadow-sm`}
                          >
                        ...
                        <div className="flex flex-col">
                          ...
                          <div
                            className={`px-2 py-1.5 rounded-lg text-xs shadow-sm ${
                              msg.type === "sent"
                          ...
                          <span
                            className={`text-[10px] text-gray-500 mt-0.5 ${msg.type === "sent" ? "text-right mr-1" : "ml-1"}`}
                          >
                            {msg.time}
                          </span>
                        </div>
