            ...
            <CardContent className="p-2">
              <div className="flex items-center justify-between">
                ...
                <div className="flex-1 max-w-sm mx-2">
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      placeholder="Search..."
                      className={`w-full pl-7 pr-2 py-1 text-xs border rounded focus:outline-none focus:ring-1 focus:ring-blue-500 transition-colors duration-300 ${
                        isDarkMode
                ...
                <Button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white shadow-md px-2 py-1 text-xs h-6"
                >
