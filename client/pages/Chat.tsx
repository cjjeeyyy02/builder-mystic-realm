...
export default function Chat() {
  ...
  return (
    <>
              ...
              <CardContent className="p-0 h-full flex flex-col">
                ...
                <div className={`p-2 border-b transition-colors duration-300 ${
                  ...
                  <div className="lg:hidden flex justify-between items-center mb-2">
                    ...
                    <button
                      onClick={() => setShowMobileSidebar(false)}
                      className={`p-1 rounded ${isDarkMode ? 'text-emerald-400 hover:text-emerald-300' : 'text-emerald-600 hover:text-emerald-800'}`}
                    >
                    ...
                    <CardContent className="p-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-1">
                          ...
                          {/* Share Button - Only in Group Chat */}
                          {isGroupChat && (
                            <div className="relative">
                              <Button
                                variant="outline"
                              ...
                              {/* Share Menu */}
                              {showShareMenu && (
                                <div className={`absolute right-0 top-12 w-48 shadow-xl border-2 z-50 rounded-lg transition-all duration-300 ${
                                  ...
                                  <div className="py-2">
                                    ...
                                    <button
                                      onClick={() => handleShareOption('File')}
                                      className={`w-full text-left px-4 py-2 text-sm font-medium border-b transition-colors ${
                                        isDarkMode
                                          ? 'text-gray-200 hover:bg-gray-700 border-gray-600'
                                          : 'text-gray-800 hover:bg-gray-50 border-gray-200'
                                    ...
                                    <button
                                      onClick={() => handleShareOption('Location')}
                    ...
                    <CardContent className="p-2">
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          className="p-1.5 bg-emerald-600 text-white rounded-full hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {showGoPublicModal && selectedGroupForPublic && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <Card className={`w-full max-w-md mx-auto shadow-2xl ${
            isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'
          }`}>
            <div className="bg-gradient-to-r from-purple-600 to-purple-800 text-white px-6 py-4 rounded-t-lg flex items-center justify-between">
              <h2 className="text-lg font-bold">Make Group Public</h2>
              <button
                onClick={() => {
                  setShowGoPublicModal(false);
                  setSelectedGroupForPublic(null);
            ...
            <CardContent className="p-6">
              <div className="text-center mb-6">
                ...
                <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
                  Do You Want The Entire Chat History To Be Visible To New Participants?
                </p>
              </div>

              <div className="space-y-3">
                <Button
                  onClick={() => handleConfirmGoPublic(selectedGroupForPublic, true)}
                  className="w-full bg-green-600 hover:bg-green-700 text-white py-3"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  YES - Show Full History
                </Button>
                <Button
                  onClick={() => handleConfirmGoPublic(selectedGroupForPublic, false)}
                  variant="outline"
