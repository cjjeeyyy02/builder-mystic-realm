        ...
        <div className="flex items-center gap-3 mt-4 mb-4">
          ...
          <div className="relative dropdown-container">
            ...
            <Input
              ...
              className="w-48 h-8 text-xs bg-white border border-gray-300 hover:border-gray-400 pl-8 pr-8"
            />
            <Button
            ...
            {showCandidatesDropdown && (
              <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg z-50">
                <div className="py-1">
                  {["All Candidates", "Jaya", "Mark", "John", "Sara", "Shruti", "Robin", "Kayle", "Vali", "Anne"].map((candidate) => (
                    <button
                      key={candidate}
                      onClick={() => {
                        setSearchCandidates(candidate);
                        setShowCandidatesDropdown(false);
                      }}
          ...
          <div className="relative dropdown-container">
            ...
            <Input
              ...
              className="w-32 h-8 text-xs bg-white border border-gray-300 hover:border-gray-400 pl-8 pr-8"
            />
            <Button
            ...
            {showCountryDropdown && (
              <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg z-50">
                <div className="py-1">
                  {["All Countries", "India", "USA", "Europe", "Russia", "China", "Canada"].map((countryOption) => (
                    <button
                      key={countryOption}
                      onClick={() => {
          ...
          <div className="relative dropdown-container">
            ...
            {showJobRoleDropdown && (
              <div className="absolute top-full left-0 mt-1 w-full bg-white border border-gray-200 rounded-md shadow-lg z-50">
                <div className="py-1">
                  {["All Roles", "Senior Developer", "Graphic Designer", "Content Writer", "Copywriter", "Sale Associate", "AI Engineer", "ML Engineer", "Data Analyst", "Finance Analyst"].map((role) => (
                    <button
                      key={role}
                      onClick={() => {
                        setJobRole(role);
