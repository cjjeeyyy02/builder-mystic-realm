            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
              <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                  <h2 className="text-lg font-bold text-gray-800">Schedule Interview Slot</h2>
                  <Button
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                          <Button className="bg-gray-200 text-gray-800 text-xs px-3 py-1 h-7 font-medium">
                        ...
                        <div className="flex items-center gap-2">
                          {[16, 17, 18, 19, 20, 21].map((date) => (
                            <Button
                              key={date}
                              className="w-8 h-8 text-xs bg-purple-600 hover:bg-purple-700 text-white rounded"
                            >
                              {date}
                            </Button>
                          ))}
                          <Button className="w-8 h-8 bg-green-500 hover:bg-green-600 text-white rounded">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-3">
                        <div>
                          ...
                          <Input className="h-8 text-xs border-gray-300" />
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-2 text-xs">
                            ...
                            <Input className="h-8 text-xs border-gray-300 w-20" placeholder="10:30 AM" />
                            <span className="text-blue-600 font-medium">TO</span>
                            <Input className="h-8 text-xs border-gray-300 w-20" placeholder="11:30 AM" />
                          </div>
                        </div>
                        <div>
                      ...
                      {/* Book Button */}
                      <Button className="w-full bg-red-600 hover:bg-red-700 text-white font-bold text-xs h-10 mt-4">
