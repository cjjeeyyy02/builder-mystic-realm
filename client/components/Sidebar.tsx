      ...
      >
        ...
        <div className="p-4 border-t border-gray-100">
          {!isCollapsed ? (
            <Button
              variant="ghost"
              className="w-full justify-between items-center px-3 py-2 rounded-md text-gray-700 hover:bg-gray-50"
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  variant="ghost"
                  className="w-full justify-center p-2 rounded-md text-gray-700 hover:bg-gray-50"
                  onClick={onToggleCollapse}
                >
              ...
              <TooltipContent side="right" className="bg-white border border-gray-200">
                <p className="font-medium text-black">Expand</p>
              </TooltipContent>
            </Tooltip>
          )}
        </div>
